...
class DashboardWidgetSeeder extends Seeder
{
    ...
    protected function all(): array
    {
        return [
            'Admin', 'Manager',
            'Designer', 'Accountant', 'Developer',
            'Fitter', 'Welder', 'Electrician', 'Helper',
            'Store Manager',
        ];
    }

    protected function exec(): array { return ['Admin', 'Manager']; }
    protected function execGm(): array { return ['Admin', 'Manager']; }
    protected function execGmHr(): array { return ['Admin', 'Manager']; }
    protected function execAllMgmt(): array { return ['Admin', 'Manager', 'Accountant', 'Store Manager']; }
    protected function workers(): array { return ['Fitter', 'Welder', 'Electrician', 'Helper']; }
    protected function fieldWorkers(): array { return ['Fitter', 'Welder', 'Electrician', 'Helper']; }
    protected function allWorkers(): array { return ['Fitter', 'Welder', 'Electrician', 'Helper', 'Designer']; }
    protected function finance(): array { return ['Accountant']; }
    protected function financeExec(): array { return ['Accountant', 'Admin']; }
    ...
    protected function seedCards(): void
    {
        ...
        ], ['Admin', 'Admin', 'Admin', 'Manager', 'Manager', 'Accountant']);
        ...
        ], ['Admin', 'Admin', 'Manager', 'Manager', 'Manager', 'Manager', 'Manager']);
        ...
        ], ['Manager', 'Admin', 'Admin', 'Manager', 'Manager']);
        ...
        ], ['Manager', 'Manager', 'Admin', 'Admin', 'Manager']);
    ...
    protected function seedQuickActions(): void
    {
        ...
        ], ['Manager', 'Accountant', 'Admin', 'Admin']);
