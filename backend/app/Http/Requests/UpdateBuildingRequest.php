...
class UpdateBuildingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'fire_systems' => ['nullable', 'array'],
            'fire_systems.*.system_type' => ['required_with:fire_systems', 'string', 'max:255'],
            'fire_systems.*.sub_type' => ['nullable', 'string', 'max:255'],
            'fire_systems.*.other_details' => ['nullable', 'string', 'max:255'],
