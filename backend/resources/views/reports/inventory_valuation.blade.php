...
<div>
  <div class="s-card"><div class="n">&#8377;{{ number_format($data['totalValue'], 0) }}</div><div class="l">Total Value</div></div>
  <div class="s-card"><div class="n">{{ number_format($data['totalItems'], 0) }}</div><div class="l">Total Items</div></div>
</div>
...
<tr>
  ...
  <td class="num">{{ number_format($s->product->selling_price ?? 0, 0) }}</td>
  <td class="num">{{ number_format(($s->product->selling_price ?? 0) * $s->quantity, 0) }}</td>
</tr>
@endforeach
</table>
