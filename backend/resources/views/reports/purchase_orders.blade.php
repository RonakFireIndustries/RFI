...
<div>
  <div class="s-card"><div class="n">{{ $data['totalOrders'] }}</div><div class="l">Orders</div></div>
  <div class="s-card"><div class="n">&#8377;{{ number_format($data['totalAmount'], 0) }}</div><div class="l">Total Amount</div></div>
</div>

<table>
<tr><th>Order #</th><th>Supplier</th><th>Date</th><th class="num">Amount</th><th>Status</th></tr>
