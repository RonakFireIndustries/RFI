...
<div>
  ...
  <div class="s-card"><div class="n">{{ $data['totalPayments'] }}</div><div class="l">Payments</div></div>
</div>

<table>
<tr><th>ID</th><th class="num">Amount (&#8377;)</th><th>Date</th></tr>
@foreach($data['payments'] as $p)
<tr>
  <td>{{ $p->id }}</td>
  <td class="num">{{ number_format($p->amount ?? 0, 0) }}</td>
