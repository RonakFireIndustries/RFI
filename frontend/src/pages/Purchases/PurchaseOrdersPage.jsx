...
export default function PurchaseOrdersPage() {
  ...
  const [newOrder, setNewOrder] = useState({ supplier_id: '', site_id: '', gst_type: 'cgst', shipping_cost: 0, other_cost: 0, other_cost_note: '', terms_conditions: '', items: [{ parent_category_id: '', category_id: '', product_id: '', custom_product_name: '', quantity: 1, unit_cost: 0, gst_rate: 18, hsn_code: '' }] });
  ...
  const handleCreatePO = async (e, status = 'Pending Approval') => {
    ...
    try {
      ...
      fetchOrders();
      setNewOrder({ supplier_id: '', site_id: '', gst_type: 'cgst', shipping_cost: 0, other_cost: 0, other_cost_note: '', terms_conditions: '', items: [{ parent_category_id: '', category_id: '', product_id: '', custom_product_name: '', quantity: 1, unit_cost: 0, gst_rate: 18, hsn_code: '' }] });
    } catch (error) {
                ...
                <div className="flex-1 space-y-6">
                  ...
                  <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    <div className="p-6 border-b border-gray-100 flex justify-between items-center">
                      ...
                      <button
                        type="button"
                        onClick={() => setNewOrder({ ...newOrder, items: [...newOrder.items, { parent_category_id: '', category_id: '', product_id: '', custom_product_name: '', quantity: 1, unit_cost: 0, gst_rate: 18, hsn_code: '' }] })}
